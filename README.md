...
# :o:前言
> 花了2天时间收尾之前剩余的汉化工程并更新了0.03补丁，不考虑进一步精翻完善对话的话，则本补丁已基本到头，可以放心爽玩。

# :o:补丁介绍
本补丁汉化范围为[Acting Lessons](https://store.steampowered.com/app/1045520/)：
<br>原汉化文本取自大帝国汉化组1.0.0版，整体文本质量尚可，略微调整了下人名，针对机翻或些许语句进行了小部分翻译修改，重新修改&添加游戏内所有图片翻译。<br>顺便说一下，我自己改或者翻译的话向来还是以尽量还原英文原意为主，不会刻意加上个人观点或网络用语&梗，对我而言会比较出戏、破坏氛围。但可能存在因功力欠缺而没能更好更准确的表达原意，这点只能见谅了。
<br><br><br>
...
# :o:汉化剩余进度简述
1. 不考虑进一步精翻完善对话的话，则本补丁已基本到头，可以放心爽玩
<br>
...
# :o:补丁更新记录
**<details><summary>:beginner:2024.10.23_AL.CN_Ver0.03.GameVer1.0.2</summary>**
- 实装所有章节提示翻译
- 完善所有标点符号格式&各项拟声词翻译
- 添加&修改共55张图片翻译：<br>(短信内容、来电提示、每章标题、关系报告标题、关系报告人名、游玩警告、游戏标题、完结&开发支持)<br>**本次补丁更新预计已完成游戏内所有图片翻译，如有缺漏请反馈**</details>
